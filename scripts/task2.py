...
df_clean = db.drop(['HTTP DL (Bytes)', 'HTTP UL (Bytes)', 'Nb of sec with 125000B < Vol DL', 'Nb of sec with 1250B < Vol UL < 6250B', 'Nb of sec with 31250B < Vol DL < 125000B', 'Nb of sec with 37500B < Vol UL', 'Nb of sec with 6250B < Vol DL < 31250B', 'Nb of sec with 6250B < Vol UL < 37500B',], axis=1)
...
df_clean.fillna(db.mean(), inplace = True)
...
# Top 10 per column
print(df_agg.nlargest(10, 'Sessions Frequency', keep='last'))
print(df_agg.nlargest(10, 'Duration of Session', keep='last'))
print(df_agg.nlargest(10, 'Sessions Total Traffic', keep='last'))
